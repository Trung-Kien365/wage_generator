...
* **Ưu điểm:** **Tiết kiệm triệt để tài nguyên Block RAM**, tối ưu hóa cho các dòng chip cũ hoặc hạn chế về tài nguyên Cyclone II trên board DE2.
...
* **Kiến trúc DSP:** Direct Digital Synthesis, Bảng tra LUT, Bộ tạo sóng FSM, I2S Controller, I2C Controller.
